<template>
  <div>
    ...
    <div id="header-holder">
      ...
      <nav
        id="main-nav"
        class="navbar navbar-default navbar-full"
      >
            ...
            <div class="pricing-box">
              ...
              <div class="pricing-link">
                <a
                  class="order-link"
                  href="#"
                >Order now <i class="sphst sphst-arrow-down"></i></a>
              </div>
            </div>
          </div>
          <div class="col-sm-6 col-md-4">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="testimonial-box right-img">
              <div class="row">
                <div class="col-xs-3 img-holder dot-color1"><img
            ...
            <div class="testimonial-box right-img">
              <div class="row">
                <div class="col-xs-3 img-holder dot-color2"><img
          ...
          <div class="col-md-4">
            <div class="testimonial-box left-img">
              <div class="row">
                <div class="col-xs-3 img-holder dot-color3"><img
            ...
            <div class="testimonial-box left-img">
              <div class="row">
                <div class="col-xs-3 img-holder dot-color4"><img
    ...
    >
      <div class="row">
        <div class="col-md-12">
          <span class="text">Lorem ipsum dolor sit amet, consectetur adipiscing.</span> <a
            href="#"
            class="button-bluegrey"
          >Request a Demo</a><a
            href="#"
            class="button-purple"
              ...
              <div class="row">
                ...
                >
                  <div class="form-items-holder">
                    <div class="col-sm-12 col-md-6"><input
                        type="text"
                        id="name"
                        name="name"
